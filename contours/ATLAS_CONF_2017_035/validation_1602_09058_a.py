...
sms_topo = r'$\tilde \chi^{\pm}_1  \to \tau \nu \tilde \chi^0_1 $'
#sms_topo = r'$\tilde \chi ^{\pm}_1 \to ??$'

plot_name = 'atlas_conf_2017_035_a.pdf'
infile = 'atlas_conf_2017_035_a.txt'
...
obs0 = np.loadtxt('035_a_Obs.dat', delimiter= ',').transpose()
obsup = np.loadtxt('035_a_ObsSup.dat', delimiter=',').transpose()
obsdw = np.loadtxt('035_a_ObsInf.dat', delimiter=',').transpose()
