...
sms_topo = r'$\tilde \chi^{\pm}_1 \chi^{\pm}_2  \to 2 \times \tau \nu \tilde \chi^0_1 $'
#sms_topo = r'$\tilde \chi ^{\pm}_1 \to ??$'

plot_name = 'atlas_conf_2017_035_b.pdf'
infile = 'atlas_conf_2017_035_b.txt'
...
obs0 = np.loadtxt('035_b_Obs.dat', delimiter=',').transpose()
obsup = np.loadtxt('035_b_ObsSup.dat', delimiter=',').transpose()
obsdw = np.loadtxt('035_b_ObsInf.dat', delimiter=',').transpose()
