...
sms_topo = r'$\tilde \chi ^{\pm}_1 \tilde \chi_2^0  \to ll \tilde \chi^0_1 $'
#sms_topo = r'$\tilde \chi ^{\pm}_1 \to ??$'

plot_name = 'atlas_conf_2017_039_d.pdf'
infile = 'atlas_conf_2017_039_d.txt'
...
## obs0 = np.loadtxt('039_d_Obs.dat', delimiter=',').transpose()
