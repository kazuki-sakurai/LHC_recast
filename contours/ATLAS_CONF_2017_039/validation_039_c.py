...
sms_topo = r'$\tilde l  \to l \chi^0_1 $'
#sms_topo = r'$\tilde \chi ^{\pm}_1 \to ??$'

plot_name = 'atlas_conf_2017_039_c.pdf'
infile = 'atlas_conf_2017_039_c.txt'
...
ax.set_xlabel(r'$m_{\tilde l} [\rm GeV]$', fontsize=23)
ax.set_ylabel(r'$m_{\tilde \chi_1^0} [\rm GeV]$', fontsize=23)
# axes ranges
...
obs0 = np.loadtxt('039_c_Obs.dat', delimiter=',').transpose()
## obsup = np.loadtxt('1602_09058_a_ObsSup.dat', delimiter=',').transpose()
## obsdw = np.loadtxt('1602_09058_a_ObsInf.dat', delimiter=',').transpose()
