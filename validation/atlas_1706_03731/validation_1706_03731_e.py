...
plot_name = '1706_03731_e.pdf'
infile = '1706_03731_e.txt'
...
obs0 = np.loadtxt('atlasObs0_c.dat', delimiter=',').transpose()
obsup = np.loadtxt('atlasObs+1_c.dat', delimiter=',').transpose()
obsdw = np.loadtxt('atlasObs-1_c.dat', delimiter=',').transpose()
