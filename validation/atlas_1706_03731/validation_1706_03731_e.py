...
obs0 = np.loadtxt('atlasObs0_e.dat', delimiter=',').transpose()
obsup = np.loadtxt('atlasObs+1_e.dat', delimiter=',').transpose()
obsdw = np.loadtxt('atlasObs-1_e.dat', delimiter=',').transpose()
