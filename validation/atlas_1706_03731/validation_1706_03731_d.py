...
obs0 = np.loadtxt('atlasObs0_d.dat', delimiter=',').transpose()
obsup = np.loadtxt('atlasObs+1_d.dat', delimiter=',').transpose()
obsdw = np.loadtxt('atlasObs-1_d.dat', delimiter=',').transpose()
