...
obs0 = np.loadtxt('atlasObs0_a.dat', delimiter=',').transpose()
obsup = np.loadtxt('atlasObs+1_a.dat', delimiter=',').transpose()
obsdw = np.loadtxt('atlasObs-1_a.dat', delimiter=',').transpose()
...
ax.fill_between([0,3000], [-160,3000-160], [3000,3000], lw=1, alpha=0.3, facecolor='gray')
