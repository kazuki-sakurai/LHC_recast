...
ax.set_ylabel(r'$m_{\tilde \chi_1^0} [\rm GeV]$', fontsize=23)
# axes ranges
ax.set_xlim([min(xar)*0.7, max(xar)*1.05])
...
obs0 = np.loadtxt('1602_09058_b_Obs.dat', delimiter=',').transpose()
obsup = np.loadtxt('1602_09058_b_ObsSup.dat', delimiter=',').transpose()
obsdw = np.loadtxt('1602_09058_b_ObsInf.dat', delimiter=',').transpose()
