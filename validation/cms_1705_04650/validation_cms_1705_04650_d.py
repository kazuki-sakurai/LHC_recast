...
sms_topo = r'$\tilde b  \to b \tilde \chi^0_1 $'
#sms_topo = r'$\tilde \chi ^{\pm}_1 \to ??$'

plot_name = 'cms_1705_04650_d.pdf'
infile = 'cms_1705_04650_d.txt'
...
obs0 = np.loadtxt('cmsObs0_d.dat', delimiter=',').transpose()
obsup = np.loadtxt('cmsObs+1_d.dat', delimiter=',').transpose()
obsdw = np.loadtxt('cmsObs-1_d.dat', delimiter=',').transpose()
