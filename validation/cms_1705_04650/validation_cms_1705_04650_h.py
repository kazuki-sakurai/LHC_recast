...
sms_topo = r'$\tilde t  \to bW \tilde \chi^0_1 $'
#sms_topo = r'$\tilde \chi ^{\pm}_1 \to ??$'

plot_name = 'cms_1705_04650_h.pdf'
infile = 'cms_1705_04650_h.txt'
...
ax.set_xlabel(r'$m_{\tilde t} [\rm GeV]$', fontsize=23)
ax.set_ylabel(r'$m_{\tilde \chi_1^0} [\rm GeV]$', fontsize=23)
# axes ranges
...
obs0 = np.loadtxt('cmsObs0_h.dat', delimiter=',').transpose()
obsup = np.loadtxt('cmsObs+1_h.dat', delimiter=',').transpose()
obsdw = np.loadtxt('cmsObs-1_h.dat', delimiter=',').transpose()
