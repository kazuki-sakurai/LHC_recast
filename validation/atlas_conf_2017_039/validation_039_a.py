...
sms_topo = r'$\tilde \chi ^{\pm}_1  \to 2 \times l \nu \tilde \chi^0_1 $'
#sms_topo = r'$\tilde \chi ^{\pm}_1 \to ??$'

plot_name = 'atlas_conf_2017_039_a.pdf'
infile = 'atlas_conf_2017_039_a.txt'
...
obs0 = np.loadtxt('039_a_Obs.dat', delimiter=',').transpose()
