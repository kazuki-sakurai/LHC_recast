...
#          BR         NDA      ID1       ID2
     5.000000E-01     2    -1000015          16     # BR(~chi_1+ -> ~tau+  ntau)
     5.000000E-01     2     1000016         -15     # BR(~chi_1+ -> ~ntau  tau+)     
#
DECAY   1000023     1.72043260E+00   # N2 decays
#          BR         NDA      ID1       ID2
     2.500000E-01     2     1000015         -15     # BR(~chi_20 -> ~tau-  tau+)
     2.500000E-01     2    -1000015          15     # BR(~chi_20 -> ~tau+  tau-)
     2.500000E-01     2     1000016         -16     # BR(~chi_20 -> ~ntau*  ntau)
     2.500000E-01     2    -1000016          16     # BR(~chi_20 -> ~ntau  ntau*)
#
