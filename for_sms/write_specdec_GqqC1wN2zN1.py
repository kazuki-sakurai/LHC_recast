...
decouple = 10000.
mQ = decouple
mA = mB1 = mB2 = mT1 = mT2 = mL = mN3 = mN4 = mC2 = decouple
...
#
DECAY   1000021     1.72043260E+02   # gluino decays
#          BR         NDA      ID1       ID2
     2.5E-01          3     1000024         1        -2   # BR(~chi_1+ -> ~chi_1+ d    ub)
     2.5E-01          3    -1000024         2        -1   # BR(~chi_1+ -> ~chi_1- u    db)
     2.5E-01          3     1000024         3        -4   # BR(~chi_1+ -> ~chi_1+ s    cb)
     2.5E-01          3    -1000024         4        -3   # BR(~chi_1+ -> ~chi_1- c    sb)
DECAY   1000024     1.72043260E+00   # gluino decays
#          BR         NDA      ID1       ID2
     1.0E+00          2     1000023         24            # BR(~chi_1+ -> ~chi_20 w+)
DECAY   1000023     1.72043260E+00   # gluino decays
#          BR         NDA      ID1       ID2
     1.0E+00          2     1000022         23            # BR(~chi_20 -> ~chi_10 z0)     
