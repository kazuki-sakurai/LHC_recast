...
decouple = 10000.
mQ = mG = decouple
mA = mL = mB1 = mB2 = mT1 = mT2 = mN3 = mN4 = mC2 = mlepR = decouple
...
#
DECAY   24     1.72043260E+00   # W decays
#          BR         NDA      ID1       ID2
       0.5000E+00     2         -11         12     # BR(W+ -> ebar  nu_e)
       0.5000E+00     2         -13         14     # BR(W+ -> mubar nu_mu)       
DECAY   23     1.72043260E+00   # Z decays
#          BR         NDA      ID1       ID2
       0.5000E+00     2         11        -11     # BR(Z -> e+  e-)
       0.5000E+00     2         13        -13     # BR(Z -> mu+  mu-)
