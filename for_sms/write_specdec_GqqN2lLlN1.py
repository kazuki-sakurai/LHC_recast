...
decouple = 10000.
mQ = decouple
mA = mB1 = mB2 = mT1 = mT2 = mN3 = mN4 = mC1 = mC2 = mlepR = decouple
...
#          BR         NDA      ID1       ID2
     2.5E-01          3     1000023         1        -1   # BR(~g -> ~chi_20 d    db)
     2.5E-01          3     1000023         2        -2   # BR(~g -> ~chi_20 u    ub)
     2.5E-01          3     1000023         3        -3   # BR(~g -> ~chi_20 s    sb)          
     2.5E-01          3     1000023         4        -4   # BR(~g -> ~chi_20 c    cb)
