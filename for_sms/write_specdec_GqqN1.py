...
#          BR         NDA      ID1       ID2
     2.5E-01          3     1000022         1        -1   # BR(~chi_1+ -> ~chi_10 d    db)
     2.5E-01          3     1000022         2        -2   # BR(~chi_1+ -> ~chi_10 u    ub)
     2.5E-01          3     1000022         3        -3   # BR(~chi_1+ -> ~chi_10 s    sb)          
     2.5E-01          3     1000022         4        -4   # BR(~chi_1+ -> ~chi_10 c    cb)
