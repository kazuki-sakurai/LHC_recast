...
decouple = 10000.
mG = decouple
mA = mB1 = mB2 = mT1 = mT2 = mL = mN2 = mN3 = mN4 = mC1 = mC2 = decouple
...
#
DECAY   1000002     6.38610997E+01   # sup_L decays
#          BR         NDA      ID1       ID2
          1.0          2     1000022         2   # BR(~u_L -> ~chi_10 u)
DECAY   2000002     1.67972766E+01   # sup_R decays
          1.0          2     1000022         2   # BR(~u_R -> ~chi_10 u)
DECAY   1000001     6.38496387E+01   # sdown_L decays
          1.0          2     1000022         1   # BR(~d_L -> ~chi_10 d)
DECAY   2000001     4.16382206E+00   # sdown_R decays
          1.0          2     1000022         1   # BR(~d_R -> ~chi_10 d)
DECAY   1000004     6.38610997E+01   # scharm_L decays
          1.0          2     1000022         4   # BR(~c_L -> ~chi_10 c)
DECAY   2000004     1.67972766E+01   # scharm_R decays
          1.0          2     1000022         4   # BR(~c_R -> ~chi_10 c)
DECAY   1000003     6.38496387E+01   # sstrange_L decays
          1.0          2     1000022         3   # BR(~s_L -> ~chi_10 s)
'''.format(mN1=mN1, mQ=mQ, mG=mG, mA=mA, mB1=mB1, mB2=mB2, mT1=mT1, mT2=mT2, mL=mL, mN2=mN2, mN3=mN3, mN4=mN4, mC1=mC1, mC2=mC2)
