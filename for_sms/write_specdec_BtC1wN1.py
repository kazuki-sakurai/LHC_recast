...
decouple = 10000.
mG = decouple
mA = mQ = mB2 = mT1 = mT2 = mL = mN2 = mN3 = mN4 = mC2 = decouple
...
#
DECAY   1000005     6.38610997E+01   # sbottom_1 decays
#          BR         NDA      ID1       ID2
          1.0          2    -1000024         6   # BR(~b_1 -> ~chi_1- t)
DECAY   1000024     1.72043260E+00   # cha1 decays
#          BR         NDA      ID1       ID2
